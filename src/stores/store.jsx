...
class Store {
  constructor() {
    ...
    this.store = {
      ...
      rewardPools: [
        {
          id: 'Trianon Processor pool',
          name: 'yfarmland.finance',
          website: 'process.yfarmland.finance',
          link: 'https://process.yfarmland.finance/',
          YieldCalculatorLink: "",   //收益率器地址
          depositsEnabled: true,
          tokens: [
            {
              id: 'Trianon Processor pool SWAP Pool',
              address: config.yfiAddress,
              symbol: 'YFARMER',
              abi: config.erc20ABI,
              decimals: 18,
              rewardsAddress: config.swapcontractAddress,
              rewardsABI: config.swapcontractABI,
